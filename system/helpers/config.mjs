...
THOSEWHOWANDER.labels = {
  ...
  "add_action": "THOSEWHOWANDER.label.add_action",
  "remove_action": "THOSEWHOWANDER.label.remove_action",
  "resistances": "THOSEWHOWANDER.label.resistances",
  "refresh_pools": "THOSEWHOWANDER.label.refresh_pools",
  ...
  "increase_speed": "THOSEWHOWANDER.label.increase_speed",
  "decrease_speed": "THOSEWHOWANDER.label.decrease_speed",
